    ...
    <div className="min-h-screen bg-[#f3f3f1] text-neutral-900">
      ...
      <header className="border-b border-neutral-200 bg-white">
        <div className="mx-auto flex h-16 max-w-6xl items-center px-4 sm:px-6">
          <a href="/" className="inline-flex items-center gap-1 text-sm font-medium text-neutral-700 hover:text-neutral-900">
            <ChevronLeft className="size-4" /> Fundraiser
          </a>
          <a href="/" className="absolute left-1/2 flex -translate-x-1/2 items-center gap-1.5">
