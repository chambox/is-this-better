  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
          ...
          <div className="mt-8 space-y-4">
            {[
              ...
              <div key={s.step} className="flex items-start gap-5 rounded-2xl bg-white p-6 ring-1 ring-neutral-100">
                <span className="grid size-12 shrink-0 place-items-center rounded-full text-lg font-black text-white" style={{ background: ORANGE }}>
                  {s.step}
                </span>
                <div>
          ...
          <div className="mt-10 flex items-start gap-4 rounded-3xl border border-[#FFE2CB] bg-[#FFF7F0] p-6">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-neutral-700">
                ...
                <Link to="/contact" className="font-bold underline" style={{ color: ORANGE }}>
                  contact us
                </Link>{" "}
      ...
      <section className="mx-auto max-w-3xl px-4 py-16 text-center sm:px-8">
        <RefreshCw className="mx-auto size-8" style={{ color: ORANGE }} />
